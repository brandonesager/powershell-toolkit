...
.DESCRIPTION   
	...
	.PARAMETER AddLicenses
		Strings. Licenses to add in O365 / Microsoft Online. Example: -AddLicenses "contoso:ATP_ENTERPRISE","contoso:ENTERPRISEPACK"
    ...
    Category: M365-Entra
.KEYWORDS
    user, provision, Exchange, mailbox, hybrid
#>    
Param (
...
# TODO: Migrate from AzureAD/MSOnline to Microsoft.Graph module
