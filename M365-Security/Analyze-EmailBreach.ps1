...
.PARAMETER FocusUser
    Specific user to focus analysis on (e.g., "jdoe")
...
.EXAMPLE
    .\Analyze-EmailBreach.ps1 -Path "." -FocusUser "jdoe" -ExportReport -IncludeSignInLogs
.EXAMPLE
    .\Analyze-EmailBreach.ps1 -FocusUser "jdoe" -IncludeSignInLogs -DaysBack 14

.NOTES
    Category: M365-Security

.KEYWORDS
    compliance, BEC, breach, sign-in, Graph
#>
