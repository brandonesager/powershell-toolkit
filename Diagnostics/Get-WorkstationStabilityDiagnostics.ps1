<#
.SYNOPSIS
    Comprehensive workstation stability diagnostics for CAD workstations
    
.DESCRIPTION
    Diagnoses system instability issues with focus on:
    - ECC Memory detection and health
    - Application crashes (AutoCAD, Revit, Bluebeam)
    - System errors and BSOD history
    - Hardware health and configuration
    
.NOTES
    Created: 2025-10-29
    Category: Diagnostics
.KEYWORDS
    diagnose, stability, ECC, crash, hardware
#>
...
$DaysBack = 30  # Days of event logs to review
$TopProcessCount = 10  # Number of top memory-consuming processes to report
